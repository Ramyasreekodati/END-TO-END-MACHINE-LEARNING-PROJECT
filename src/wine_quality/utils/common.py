...
@ensure_annotations     # creating the directions
...
@ensure_annotations     # if you want to load any js file we use this function
...
@ensure_annotations     # if you want to load any binary file we use this funciton
